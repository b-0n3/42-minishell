...
typedef struct s_array_iterator{
 ...
 struct s_array_list{
    ...
    t_bool (*replace_by_key)(struct s_array_list *this, t_string key, void *new_one, void (*del)(void *));
}	;

t_bool map_replace_by_key(struct s_array_list *this, t_string key, void *new_one, void (*del)(void *));
