...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/04 22:37:51 by am-khant          #+#    #+#             */
/*   Updated: 2021/12/05 02:21:34 by am-khant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct	s_array_list
{
	...
	t_bool					(*push_clone)(struct s_array_list *this, struct s_array_list original, t_bool is_not_primitive, void *(*__clone)(void *item));
